...
template struct ion::ConvolveTaskData<float>;
...
template void				 ion::InitConvolveThreads(uint32_t num_threads, ConvolveTaskData<double>& task_data);
//float
...
template void				 ion::InitConvolveThreads(uint32_t num_threads, ConvolveTaskData<float>& task_data);
//uint8_t
...
template void				  ion::InitConvolveThreads(uint32_t num_threads, ConvolveTaskData<uint8_t>& task_data);
//uint32_t
...
template void				   ion::InitConvolveThreads(uint32_t num_threads, ConvolveTaskData<uint32_t>& task_data);
