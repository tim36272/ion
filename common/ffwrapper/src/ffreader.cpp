...
#define INBUF_SIZE 4096
	...
	namespace ion
	{
		...
		static int decode_packet(int *got_frame, FFimpl* impl)
		{
			int ret = 0;
		...
		ion::Matrix<uint8_t> FFReader::ReadFrame()
		{
			int result;
			int got_frame = 0;
			...
			ion::Matrix<uint8_t> temp(impl->height_,impl->width_,3, impl->rgb_data_);
			return temp;
		}
	};
